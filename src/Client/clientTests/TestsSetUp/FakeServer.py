...
class FakeServer:
    ...
    def handle_client(self, conn, addr, curr_client: ServerClient):
    ...
    def start(self):
        ...
        while True:
            ...
            new_client = ServerClient(conn, curr_name, addr, udp_port)
    ...
    def handle_client_udp(self, client: ServerClient):
